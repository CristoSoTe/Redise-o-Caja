...
class MisFunciones:
    def __init__(self, ventana, lista_series_botones, lista_series_venta, lista_Entry_carton_salida, lista_carton_salidas, lista_series_liquidacion):
    ...
    def cartones_salidas(self):
        ...
        for i in range(4):
            ...
            if self.lista_series_venta[1].cget("text") == "0":
            ...
            for h in range(7):
                if self.lista_series_venta[h+2].cget("text") == "0":
